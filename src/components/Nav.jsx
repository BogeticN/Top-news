    ...
    return (
        <header>
            <nav>
                ...
                {open ? <div className="nav-links" style={{ visibility: 'visible',left: '0vh' }}>
                    <Link onClick={() => setOpen(false)} to='/'>Top News</Link>
                    <Link onClick={() => setOpen(false)} to='/categories'>Categories</Link>
                    <Link onClick={() => setOpen(false)} to='/search'>Search</Link>
                </div>
                    :
            ...
            <div className="country-buttons">
                {theme === "-dark" ?
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="white" className="bi bi-moon" viewBox="0 0 16 16">
